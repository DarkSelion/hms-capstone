...
class RefundApprovedMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: "Refund Approved — {$this->reservation->reservation_number}",
        );
    }
    ...
    private function buildHtml(): string
    {
        ...
        $totalPaid = number_format((float) $this->reservation->paid_amount, 2);
        $year = date('Y');
    ...
    <tr><td align="center">
      <table width="500" cellpadding="0" cellspacing="0" style="background-color:#1a2d47;border-radius:16px;overflow:hidden;border:1px solid rgba(192,160,98,0.15);">
        ...
        <tr><td style="padding:20px 40px;">
          <h2 style="color:#ffffff;font-size:20px;font-weight:400;margin:0 0 12px;text-align:center;">Refund Approved</h2>
          ...
          <p style="color:rgba(255,255,255,0.6);font-size:14px;line-height:1.6;margin:0 0 20px;text-align:center;">
            Your refund request for booking <strong style="color:rgba(255,255,255,0.8);">{$bookingRef}</strong> has been approved.
          </p>
          <!-- Refund Details -->
          <div style="background:rgba(34,197,94,0.08);border:1px solid rgba(34,197,94,0.2);border-radius:12px;padding:24px;margin:0 0 20px;">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="color:rgba(255,255,255,0.5);font-size:13px;padding:4px 0;">Refund Amount</td>
                <td style="color:#22c55e;font-size:18px;font-weight:600;text-align:right;padding:4px 0;">₱{$amount}</td>
              </tr>
              <tr>
          ...
          <p style="color:rgba(255,255,255,0.4);font-size:13px;text-align:center;margin:0;">
            If you have any questions, please contact us at info@pampangahomesuites.com.
          </p>
        </td></tr>
        <!-- Footer -->
